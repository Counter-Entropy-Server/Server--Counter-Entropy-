...
#http://localhost:3000/devices/setDeviceStateByAddress?address=00&state=0
...
def getDeviceByName
    @device = Device.find_by_var_name(params[:name])	
    @logs = Log.find_all_by_address(@device[:address],:order => :time)
    render json: @logs.last
end
#http://localhost:3000/devices/getDeviceByName?address=00
def getDeviceByAddress
    @device = Device.find_by_address(params[:address])	
    @logs = Log.find_all_by_address(@device[:address],:order => :time)
    render json: @logs.last
end
#http://localhost:3000/devices/getRangeByName?name=light&start_time=2012-08-05%2022:53:02&end_time=2012-08-05%2023:55:02
def getRangeByName
    @device = Device.find_by_var_name(params[:name])	
...
#http://localhost:3000/devices/getRangeByName?address=00&start_time=2012-08-05 18:57:02&end_time=2012-08-05 22:41:02
