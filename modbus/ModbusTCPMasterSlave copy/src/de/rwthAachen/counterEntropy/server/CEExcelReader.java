...
/**
 *
 * Takes excel file path as input and returns a HashMap of keys:variable-name, values:CEHouseVariable-objects.
 * NOTE: While reading the file the arrangment of cloumns in the sheet is essential
 */
public class CEExcelReader {
