...
public class ReadSlaveTimerCall extends TimerTask { 
    ...
    private DBComm db = null;
    private ServerSocketComm socket = null;
    private HashMap houseVariables = null;
    
    public ReadSlaveTimerCall(CEModbusTCPMaster master, CEHouse house, DBComm db, ServerSocketComm socket){
        this.master = master;
        this.house = house;
        this.db = db;
        this.socket = socket;
    ...
    {      
        ...
        for (int i = 0; i < house.getMemorySequances().size(); i++){
            ...
            seq = (MBAddressSequance)house.getMemorySequances().get(i);
